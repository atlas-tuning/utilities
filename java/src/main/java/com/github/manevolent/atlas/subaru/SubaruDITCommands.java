...
public final class SubaruDITCommands {
    ...
    public static final UDSSecurityAccessCommand SECURITY_ACCESS_7_8 =
            new SubaruSecurityAccessCommandAES(0x7, ENGINE_2, Crypto.toByteArray("7692E7932F23A901568DDFA5FF580625"));

    public static final UDSSecurityAccessCommand SECURITY_ACCESS_1_2 =
            new SubaruSecurityAccessCommandAES(0x1, ENGINE_2, Crypto.toByteArray("667E3078219976B4EDF3D43BD1D8FFC9"));
